...
$title{FIR Hardware Accelerator}
...
$texttt{fir$_test} is just the name I chose for the compiled simulation
output.
...
$begin{itemize}
    ...
    $item 5 cells
    $item 2 $texttt{$$add} cells
    $item 3 $texttt{$$mul} cells
$end{itemize}
